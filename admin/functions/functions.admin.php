...
function optionsframework_admin_message()
{
    ...
    jQuery(function(){
        ...
        var message = '<p>This theme comes with an <a href="<?php echo admin_url(
            "admin.php?page=optionsframework"
        ); ?>">options panel</a> to configure settings. This theme also supports widgets, please visit the <a href="<?php echo admin_url(
    "widgets.php"
