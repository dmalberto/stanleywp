...
function optionsframework_admin_init()
{
    ...
    do_action("optionsframework_admin_init_before", [
    ...
    do_action("optionsframework_admin_init_after", [
        "of_options" => $of_options,
        "options_machine" => $options_machine,
        "smof_data" => $smof_data,
    ]);
...
function of_style_only()
{
    ...
    wp_enqueue_style(
        "jquery-ui-custom-admin",
        ADMIN_DIR . "assets/css/jquery-ui-custom.css"
    );
    if (!wp_style_is("wp-color-picker", "registered")) {
        wp_register_style(
            "wp-color-picker",
            ADMIN_DIR . "assets/css/color-picker.min.css"
        );
    }
...
function of_load_only()
{
    ...
    wp_enqueue_script(
        "jquery-input-mask",
        ADMIN_DIR . "assets/js/jquery.maskedinput-1.2.2.js",
        ["jquery"]
    );
    wp_enqueue_script("tipsy", ADMIN_DIR . "assets/js/jquery.tipsy.js", [
        "jquery",
    ]);
    ...
    wp_enqueue_script("smof", ADMIN_DIR . "assets/js/smof.js", ["jquery"]);
    // Enqueue colorpicker scripts for versions below 3.5 for compatibility
    if (!wp_script_is("wp-color-picker", "registered")) {
        wp_register_script(
            "iris",
            ADMIN_DIR . "assets/js/iris.min.js",
        ...
        wp_register_script(
            "wp-color-picker",
            ADMIN_DIR . "assets/js/color-picker.min.js",
            ["jquery", "iris"]
        );
    }
