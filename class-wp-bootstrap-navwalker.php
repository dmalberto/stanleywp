...
if (!class_exists("WP_Bootstrap_Navwalker")):
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        {
            if (
                !has_filter("wp_nav_menu_args", [
                    $this,
                    "add_schema_to_navbar_ul",
                ])
            ) {
        ...
        public function start_lvl(&$output, $depth = 0, $args = null)
        {
            ...
            if (end($matches[2])) {
                ...
                $labelledby =
                    'aria-labelledby="' . esc_attr(end($matches[2])) . '"';
            }
        ...
        public function start_el(
            ...
            if (
                false !== strpos($args->items_wrap, "itemscope") &&
                false === $this->has_schema
            ) {
                $this->has_schema = true;
                $args->link_before =
                    '<span itemprop="name">' . $args->link_before;
             ...
             */
            $classes = $this->separate_linkmods_and_icons_from_classes(
                $classes,
                $linkmod_classes,
                $icon_classes,
                $depth
            ...
            $atts = $this->update_atts_for_linkmod_type(
                $atts,
                $linkmod_classes
            );
            ...
            if ("" !== $linkmod_type) {
                ...
                $item_output .= $this->linkmod_element_open(
                    $linkmod_type,
                    $attributes
                );
            } else {
            ...
            if ($args["container"]) {
                ...
                if (
                    ...
                    $id = $args["container_id"]
                        ...
                        : "";
                    $fallback_output .=
                        "<" . $args["container"] . $id . $class . ">";
                }
            }
            // The fallback menu.
            $class = $args["menu_class"]
                ? ' class="menu-fallback-menu ' .
        ...
        private function linkmod_element_open($linkmod_type, $attributes = "")
        {
            ...
            if ("dropdown-item-text" === $linkmod_type) {
                $output .=
                    '<span class="dropdown-item-text"' . $attributes . ">";
                 ...
                 */
                $output .=
                    '<span class="dropdown-header h6"' . $attributes . ">";
