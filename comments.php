...
<div id="comments" class="comments-area">
    <?php if (have_comments()): ?>
        ...
        <nav class="navigation comment-navigation row clr" role="navigation">
            <h4 class="assistive-text section-heading heading"><span><?php _e(
                "Comment navigation",
                "wpex"
            ); ?></span></h4>
            <div class="nav-previous span_12 col clr-margin"><?php previous_comments_link(
                __("&larr; Older Comments", "wpex")
            ); ?></div>
            <div class="nav-next span_12 col"><?php next_comments_link(
                __("Newer Comments &rarr;", "wpex")
            ); ?></div>
        </nav>
        <?php endif;
