...
<?php
 ...
 function gents_wp_page_menu($page_markup)
 {
     ...
     $divclass = $matches[1];
     $replace = ['<div class="' . $divclass . '">', "</div>"];
...
<?php
  ...
  */ function gents_read_more()
 {
     return ' <a href="' .
         ...
         '">' .
         __(
             '<div class="read-more"><p>Leia mais >></p></div><!-- end of .read-more -->',
             "gents"
         ) .
         "</a>";
 } /**
 ...
 function gents_breadcrumb_lists()
 {
     ...
     if (is_category()) {
         ...
         if (!empty($pdata)) {
             echo "<li>" .
                 get_category_parents($pdata[0]->cat_ID, true, " ") .
                 "</li> ";
             echo $currentBefore;
         }
 ...
 if (!function_exists("gents_js")) {
     function gents_js()
     {
         ...
         wp_enqueue_script(
             "magnific",
             get_template_directory_uri() . "/js/magnific.min.js",
             ["jquery"],
             "0.9.4",
             false
         );
 ...
 function gents_widgets_init()
 {
     register_sidebar([
         ...
         "id" => "footer-left",
         "before_title" => '<div class="footer-title2">',
         "after_title" => "</div>",
