    ...
    class RWMB_Datetime_Field extends RWMB_Field
    {
        ...
        static function admin_enqueue_scripts()
        {
            ...
            wp_register_style(
                ...
                ["jquery-ui-core", "jquery-ui-theme"],
                "1.8.17"
            );
            wp_register_style(
                "jquery-ui-slider",
            ...
            wp_enqueue_style(
                ...
                "{$url}/jquery-ui-timepicker-addon.css",
                ["jquery-ui-datepicker", "jquery-ui-slider"],
                "0.9.7"
            );
            wp_register_script(
                "jquery-ui-timepicker",
                RWMB_JS_URL . "jqueryui/jquery-ui-timepicker-addon.js",
                ["jquery-ui-datepicker", "jquery-ui-slider"],
                "0.9.7",
                true
            );
            ...
            $date_path =
                "jqueryui/datepicker-i18n/jquery.ui.datepicker-" .
                $locale .
                ".js";
            $time_path =
                "jqueryui/timepicker-i18n/jquery-ui-timepicker-" .
                $locale .
                ".js";
            $deps = ["jquery-ui-datepicker", "jquery-ui-timepicker"];
            if (file_exists(RWMB_DIR . "js/" . $date_path)) {
                wp_register_script(
                    "jquery-ui-datepicker-i18n",
                    RWMB_JS_URL . $date_path,
                    ["jquery-ui-datepicker"],
                    "1.8.17",
                    true
                );
            ...
            wp_enqueue_script(
                "rwmb-datetime",
                RWMB_JS_URL . "datetime.js",
                $deps,
                RWMB_VER,
                true
            );
            wp_localize_script("rwmb-datetime", "RWMB_Datetimepicker", [
                "lang" => $locale,
            ]);
        }
        /**
        ...
        static function html($meta, $field)
        {
            return sprintf(
                ...
                $field["field_name"],
                isset($field["timestamp"]) && $field["timestamp"]
                    ? date(self::translate_format($field), $meta)
                    : $meta,
        ...
        // Missing: 't' => '', T' => '', 'm' => '', 's' => ''
        static $time_format_translation = [
            "H" => "H",
            "HH" => "H",
            "h" => "H",
            "hh" => "H",
        ...
        // Missing:  'o' => '', '!' => '', 'oo' => '', '@' => '', "''" => "'"
        static $date_format_translation = [
            "d" => "j",
            "dd" => "d",
            "oo" => "z",
            "D" => "D",
        ...
        {
            return strtr(
                $field["js_options"]["dateFormat"],
                self::$date_format_translation
            ) .
                $field["js_options"]["separator"] .
                strtr(
                    $field["js_options"]["timeFormat"],
                    self::$time_format_translation
                );
        }
    }
}
