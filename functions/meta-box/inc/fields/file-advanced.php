...
if (!class_exists("RWMB_File_Advanced_Field")) {
    class RWMB_File_Advanced_Field extends RWMB_File_Field
    {
        ...
        static function admin_enqueue_scripts()
        {
            ...
            wp_enqueue_script(
                "rwmb-file-advanced",
                RWMB_JS_URL . "file-advanced.js",
                ["jquery", "underscore"],
                RWMB_VER,
                true
            );
            wp_localize_script("rwmb-file-advanced", "rwmbFileAdvanced", [
        ...
        static function add_actions()
        {
            ...
            add_action("wp_ajax_rwmb_attach_file", [
                __CLASS__,
                "wp_ajax_attach_file",
            ]);
        ...
        static function html($meta, $field)
        {
            $i18n_title = apply_filters(
                "rwmb_file_advanced_select_string",
                _x("Select or Upload Files", "file upload", "rwmb"),
                $field
            );
