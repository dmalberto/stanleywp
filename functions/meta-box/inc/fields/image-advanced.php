...
if (!class_exists("RWMB_Image_Advanced_Field")) {
    class RWMB_Image_Advanced_Field extends RWMB_Image_Field
    {
        ...
        static function admin_enqueue_scripts()
        {
            ...
            wp_enqueue_script(
                "rwmb-image-advanced",
                RWMB_JS_URL . "image-advanced.js",
                ["jquery", "underscore"],
                RWMB_VER,
                true
            );
            wp_localize_script("rwmb-image-advanced", "rwmbImageAdvanced", [
        ...
        static function add_actions()
        {
            ...
            add_action("wp_ajax_rwmb_attach_media", [
                __CLASS__,
                "wp_ajax_attach_media",
            ]);
            add_action("print_media_templates", [__CLASS__, "print_templates"]);
        }
        /**
        ...
        static function html($meta, $field)
        {
            $i18n_title = apply_filters(
                "rwmb_image_advanced_select_string",
                _x("Select or Upload Images", "image upload", "rwmb"),
                $field
            );
