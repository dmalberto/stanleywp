...
$meta_boxes = [];
// Post Type name
$portfolio_post_type_name = bi_get_data("portfolio_post_type_name")
    ? bi_get_data("portfolio_post_type_name")
    : __("Portfolio", "gents");
//Individual Portfolio
$meta_boxes[] = [
    "id" => "portfolio_metabox",
    "title" => "Options",
    "pages" => ["portfolio"], // Post type
    "context" => "normal",
    "priority" => "high",
    "show_names" => true,
    "fields" => [
        [
            ...
            "desc" => __(
                "This is the content that will be displayed at the very top. Optional.",
                "gents"
            ),
...
$meta_boxes[] = [
    ...
    "fields" => [
        [
            "name" => __("Title", "gents"),
            "desc" => __(
                "Enter the text to be displayed above the portfolio items. ",
                "gents"
            ),
...
$meta_boxes[] = [
    ...
    "fields" => [
        [
            "name" => __("Title", "gents"),
            "desc" => __(
                "Enter the text to be displayed above the main content. ",
                "gents"
            ),
        ...
        [
            ...
            "desc" => __(
                "Enter the text to be displayed under the columns on the left. Optional.",
                "gents"
            ),
        ...
        [
            ...
            "desc" => __(
                "Enter the text to be displayed under the columns on the right. Optional.",
                "gents"
            ),
...
function wtf_register_meta_boxes()
{
    ...
    if (class_exists("RW_Meta_Box")) {
        foreach ($meta_boxes as $meta_box) {
            if (
                isset($meta_box["only_on"]) &&
                !rw_maybe_include($meta_box["only_on"])
            ) {
                continue;
            }
