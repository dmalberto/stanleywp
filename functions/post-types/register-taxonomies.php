...
if (!function_exists("bi_register_taxonomies")) {
    function bi_register_taxonomies()
    {
        ...
        $portfolio_post_type_name = bi_get_data("portfolio_post_type_name")
            ...
            : __("Portfolio", "gents");
        $portfolio_tax_slug = bi_get_data("portfolio_tax_slug")
            ? bi_get_data("portfolio_tax_slug")
            : "portfolio-category";
        // Portfolio taxonomies
        register_taxonomy("portfolio_cats", "portfolio", [
            "hierarchical" => true,
            "labels" => apply_filters("bi_portfolio_tax_labels", [
                "name" =>
                    $portfolio_post_type_name . " " . __("Categories", "gents"),
                "singular_name" =>
                    $portfolio_post_type_name . " " . __("Category", "gents"),
            ...
            "query_var" => true,
            "rewrite" => ["slug" => $portfolio_tax_slug],
        ]);
    }
} ?>
