...
$home_portfolio_cat =
    bi_get_data("home_portfolio_cat") != "Select"
        ? bi_get_data("home_portfolio_cat")
        : null;
//tax query
...
<div class="container pt">
  <div class="row mt centered">
    ...
    <?php $home_portfolio_title = bi_get_data("home_portfolio_title")
        ? bi_get_data("home_portfolio_title")
        : __("Recent Work", "gents"); ?>
    
    <?php
    $count = 0;
    while ($home_portfolio_query->have_posts()):

        $home_portfolio_query->the_post();
        $count++;
        ?>
    <!-- PORTFOLIO ITEM -->      
    <div class="col-lg-4">
