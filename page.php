    ...
    yoast_breadcrumb('<p id="breadcrumbs">', "</p>");
          ...
          <?php if ($wp_query->max_num_pages > 1): ?>
            <nav class="navigation">
              <div class="previous"><?php next_posts_link(
                  __("&#8249; Older posts", "gents")
              ); ?></div>
              <div class="next"><?php previous_posts_link(
          ...
          <article id="post-not-found" class="hentry clearfix">
            ...
            <footer>
              <h6><?php _e(
                  "You can return",
                  "gents"
              ); ?> <a href="<?php echo home_url(); ?>/" title="<?php esc_attr_e(
    "Home",
    "gents"
); ?>"><?php _e("&#9166; Home", "gents"); ?></a> <?php _e(
